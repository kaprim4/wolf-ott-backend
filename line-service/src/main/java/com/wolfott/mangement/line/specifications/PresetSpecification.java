...
@Component
public class PresetSpecification {
    public Specification<Preset> dynamic(Map<String, Object> filters) {
        return (Root<Preset> root, CriteriaQuery<?> query, CriteriaBuilder builder) -> {
            ...
            for (Map.Entry<String, Object> entry : filters.entrySet()) {
                ...
                if (value != null && !value.toString().isEmpty()) {
                    ...
                    Class<?> fieldType = getFieldType(Preset.class, key);
