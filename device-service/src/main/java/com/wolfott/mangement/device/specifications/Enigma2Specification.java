package com.wolfott.mangement.device.specifications;

import com.wolfott.mangement.device.exceptions.InvalidFilterException;
...
@Component
public class Enigma2Specification {
    public Specification<Enigma2Device> dynamic(Map<String, Object> filters) {
        return (Root<Enigma2Device> root, CriteriaQuery<?> query, CriteriaBuilder builder) -> {
            ...
            for (Map.Entry<String, Object> entry : filters.entrySet()) {
                ...
                if (value != null && !value.toString().isEmpty()) {
                    ...
                    Class<?> fieldType = getFieldType(Enigma2Device.class, key);
