package com.wolfott.mangement.epg.specifications;

import com.wolfott.mangement.epg.exceptions.InvalidFilterException;
...
@Component
public class EpgSpecification {
    public Specification<Epg> dynamic(Map<String, Object> filters) {
        return (Root<Epg> root, CriteriaQuery<?> query, CriteriaBuilder builder) -> {
            ...
            for (Map.Entry<String, Object> entry : filters.entrySet()) {
                ...
                if (value != null && !value.toString().isEmpty()) {
                    ...
                    Class<?> fieldType = getFieldType(Epg.class, key);
