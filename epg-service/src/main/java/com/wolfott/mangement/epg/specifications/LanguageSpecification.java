...
public class LanguageSpecification {
    public Specification<EpgLanguage> dynamic(Map<String, Object> filters) {
        return (Root<EpgLanguage> root, CriteriaQuery<?> query, CriteriaBuilder builder) -> {
            ...
            for (Map.Entry<String, Object> entry : filters.entrySet()) {
                ...
                if (value != null && !value.toString().isEmpty()) {
                    ...
                    Class<?> fieldType = getFieldType(EpgLanguage.class, key);
