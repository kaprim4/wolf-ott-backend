...
public class ApiSpecification {
    public Specification<EpgApi> dynamic(Map<String, Object> filters) {
        return (Root<EpgApi> root, CriteriaQuery<?> query, CriteriaBuilder builder) -> {
            ...
            for (Map.Entry<String, Object> entry : filters.entrySet()) {
                ...
                if (value != null && !value.toString().isEmpty()) {
                    ...
                    Class<?> fieldType = getFieldType(EpgApi.class, key);
