...
public class GroupSpecification {
    public Specification<UserGroup> dynamic(Map<String, Object> filters) {
        return (Root<UserGroup> root, CriteriaQuery<?> query, CriteriaBuilder builder) -> {
            ...
            for (Map.Entry<String, Object> entry : filters.entrySet()) {
                ...
                if (value != null && !value.toString().isEmpty()) {
                    ...
                    Class<?> fieldType = getFieldType(UserGroup.class, key);
