...
public class PackageSpecification {
    public Specification<UserPackage> dynamic(Map<String, Object> filters) {
        return (Root<UserPackage> root, CriteriaQuery<?> query, CriteriaBuilder builder) -> {
            ...
            for (Map.Entry<String, Object> entry : filters.entrySet()) {
                ...
                if (value != null && !value.toString().isEmpty()) {
                    ...
                    Class<?> fieldType = getFieldType(UserPackage.class, key);
