...
public class EpisodeSpecification {
    public Specification<StreamEpisode> dynamic(Map<String, Object> filters) {
        return (Root<StreamEpisode> root, CriteriaQuery<?> query, CriteriaBuilder builder) -> {
            ...
            for (Map.Entry<String, Object> entry : filters.entrySet()) {
                ...
                if (value != null && !value.toString().isEmpty()) {
                    ...
                    Class<?> fieldType = getFieldType(StreamEpisode.class, key);
    ...
    public static Specification<StreamEpisode> hasType(String type) {
