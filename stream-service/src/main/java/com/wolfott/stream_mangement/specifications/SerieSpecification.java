...
public class SerieSpecification {
    public Specification<StreamSeries> dynamic(Map<String, Object> filters) {
        return (Root<StreamSeries> root, CriteriaQuery<?> query, CriteriaBuilder builder) -> {
            ...
            for (Map.Entry<String, Object> entry : filters.entrySet()) {
                ...
                if (value != null && !value.toString().isEmpty()) {
                    ...
                    Class<?> fieldType = getFieldType(StreamSeries.class, key);
    ...
    public static Specification<StreamSeries> hasType(String type) {
