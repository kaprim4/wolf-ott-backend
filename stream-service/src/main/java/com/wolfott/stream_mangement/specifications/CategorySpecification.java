...
public class CategorySpecification {
    public Specification<StreamCategory> dynamic(Map<String, Object> filters) {
        return (Root<StreamCategory> root, CriteriaQuery<?> query, CriteriaBuilder builder) -> {
            ...
            for (Map.Entry<String, Object> entry : filters.entrySet()) {
                ...
                if (value != null && !value.toString().isEmpty()) {
                    ...
                    Class<?> fieldType = getFieldType(StreamCategory.class, key);
    ...
    public static Specification<StreamCategory> hasType(String type) {
        return (root, query, builder) ->
                type == null ?
                        builder.conjunction() :
                        builder.like(builder.lower(root.get("category_type")), "%" + type.toLowerCase() + "%");
    }
